...
<style>
  ...
  body {
    ...
    width: 100%;
    height: 100vh;
    background-image: url(../pic/cardiology.jpg);
...
<body class="container-fluid">
  <h1 class="text-monocase text-capitalize text-center text-blue">All The Doctor's Schedule List Of Cardiac Electrophysiologist</h1>
