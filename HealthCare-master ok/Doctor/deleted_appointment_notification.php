<style>
      ...
      body {
            ...
            width: 100%;
            height: 100vh;
            background-image: url(../pic/Ap1.jpg);
      ...
      <table border="1" cellPadding="13" align="center" class="table table-hover table-dark">
            ...
            <thead>
                  <tr>
                        ...
                        ?>
                              <th>
                                    <h3 class="text-center "> <?php echo "<a href='../Admin/user_detail.php?id={$drow['id']}'>{$drow['fname']}  {$drow['lname']}</a>"; ?> &nbsp; Has &nbsp;
                                          <?php echo $drow['permission']; ?>&nbsp; His/Her Appointment </h3>
                              </th>
                  </tr>
            <?php
                        }
