    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container-fluid ">
            <div class="navbar-header">
                ...
                <a class="navbar-brand text-dark" href="#myPage"><strong>Smart-healthcare</strong></a>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="item active">
                <img src="../pic/Landing_page.jpg" alt="img1" width="1500" height="800" title="Doctor Home Page">
                <div class="w3-display-middle w3-margin-top w3-center">
                    <h1 class="w3-xxlarge w3-text-white">
                        <ol class="w3-padding w3-black w3-opacity-min"><b>You can Update Appointment Schedule, Cancel Booking Request. You can also see Appointment's Request .</b></ol>
                    </h1>
                </div>
            </div>
        </div>
