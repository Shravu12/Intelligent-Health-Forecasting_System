...
<style>
	...
	body {
		...
		width: 100%;
		height: 100vh;
		background-image: url(../pic/pic\ 1.jpeg);
					...
					<form action="add_doctor.php" method="POST">
						<div class="container text-white font-weight-bold">
							...
							<labelfor="f_name"><b>First Name:</b></label><br /><br /><input class="text-dark" type="text" placeholder="Enter  First Name" name="f_name" required><br /><br />
								...
								<label for="pswd"><b>Create New Password :</b></label><br /><br /><input class="text-dark" type="password" placeholder="Create  Password" name="pswd" required>
								<p> password should be more than 8 characters long
								</p>
								<br /><br /> <input class="text-light" class="text-capitalize font-weight-bold" type="submit" name="submit" value="Register">
						</div>
						<?php
						if (isset($error_msg)) {
							echo $error_msg;
