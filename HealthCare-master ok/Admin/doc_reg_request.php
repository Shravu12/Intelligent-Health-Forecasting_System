    ...
    <table border="1" cellPadding="13" align="center" class="table table-hover table-dark">
      ...
      ?>
        ...
        <tr>
          ...
          <th>
            <h3><?php echo  $row['permission'] . "<br />"; ?></h3>
          </th>
          <th>
            <h3><?php echo $row['date'] . "<br />"; ?></h3>
          </th>
          <th>
            <h3><?php echo "<a href='doc_reg_request.php?id={$row['id']}'>Approved</a>";  ?></h3>
          </th>
          <th>
            <h3><?php echo "<a href='req_delete.php?id={$row['id']}'>Reject/Remove Account</a>";  ?></h3>
          </th>
